...
ModeConfig::ModeConfig(string _mode, const FileNode& fn) : mode(_mode) {
	...
	perform_parallel_average_ws     =               ReadBool(fn["perform"]["parallel_average_with_steps"]);
	perform_parallel_granularity    =               ReadBool(fn["perform"]["parallel_granularity"]);
	...
	parallel_average_ws_save_middle_tests = ReadBool(fn["save_middle_tests"]["parallel_average_with_steps"]);
	parallel_granularity_save_middle_tests = ReadBool(fn["save_middle_tests"]["parallel_granularity"]);
	...
	parallel_average_ws_tests_number = static_cast<int>(fn["tests_number"]["parallel_average_with_steps"]);
	parallel_granularity_tests_number = static_cast<int>(fn["tests_number"]["parallel_granularity_steps"]);
	...
	read(fn["parallel_average_datasets_with_steps"], parallel_average_ws_datasets);
	read(fn["parallel_granularity"], parallel_granularity_datasets);
...
GlobalConfig::GlobalConfig(const FileStorage& fs) {
	...
	parallel_max_threads = static_cast<int>(fs["parallel"]["max_threads"]);
	...
	parallel_average_ws_folder = "parallel_average_tests_with_steps";
	parallel_granularity_folder = "parallel_granularity";
